                ...
                temp ?
                    <div>
                        ...
                        <div className={s.contentWr}>
                            <div className={s.content}>Средняя температура воздуха: <span>{props.temp}</span> градусов
                                по Цельсию
                            </div>
                            ...
                            <div className={s.content}>Атмосферное давление составляет <span>{props.pressure}</span> мм
                                рт. ст.
                            </div>
